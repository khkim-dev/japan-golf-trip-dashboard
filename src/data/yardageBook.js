...
const yardageImage = (fileName) => `${import.meta.env.BASE_URL}images/yardage/${fileName}`
...
export const yardageCourses = [
  {
    ...
    holes: buildHoles('mizunami', [
      { hole: 1, par: 4, hdcp: 9, distanceYd: 391, mapImage: yardageImage('mizunami-hole-01-premium-cart-v1.png'), memo: '티샷은 페어웨이 중앙 우측이 안전. 그린 주변 벙커를 피하고 중앙 공략.' },
      { hole: 2, par: 5, hdcp: 3, distanceYd: 548, mapImage: yardageImage('mizunami-hole-02-premium-cart-v1.png'), memo: '긴 파5. 세컨드 욕심보다 세 번째 샷을 편하게 남긴다.' },
      { hole: 3, par: 4, hdcp: 15, distanceYd: 334, mapImage: yardageImage('mizunami-hole-03-premium-cart-v1.png'), memo: '짧은 파4. 방향성 우선, 그린 앞 벙커를 피한다.' },
      { hole: 4, par: 3, hdcp: 13, distanceYd: 166, mapImage: yardageImage('mizunami-hole-04-premium-cart-v1.png'), memo: '중거리 파3. 그린 중앙을 보고 안전하게 공략.' },
      { hole: 5, par: 5, hdcp: 1, distanceYd: 476, mapImage: yardageImage('mizunami-hole-05-premium-cart-v1.png'), memo: '핸디캡 1번 홀. 무리한 투온보다 안정적인 레이업.' },
      { hole: 6, par: 4, hdcp: 7, distanceYd: 388, mapImage: yardageImage('mizunami-hole-06-premium-cart-v1.png'), memo: '도그렉성 파4. 티샷 낙하지점과 벙커 위치 확인.' },
      { hole: 7, par: 4, hdcp: 17, distanceYd: 312, mapImage: yardageImage('mizunami-hole-07-premium-cart-v1.png'), memo: '짧은 파4. 티샷 클럽 선택으로 거리와 방향을 조절.' },
      { hole: 8, par: 3, hdcp: 11, distanceYd: 169, mapImage: yardageImage('mizunami-hole-08-premium-cart-v1.png'), memo: '파3. 그린 주변 벙커를 피해 캐리 거리 확인.' },
      { hole: 9, par: 4, hdcp: 5, distanceYd: 386, mapImage: yardageImage('mizunami-hole-09-premium-cart-v1.png'), memo: '전반 마무리 파4. 세컨드가 길 수 있어 티샷 거리 확보.' },
      { hole: 10, par: 5, hdcp: 16, distanceYd: 471, mapImage: yardageImage('mizunami-hole-10-premium-cart-v1.png'), memo: '후반 시작 파5. 물과 벙커를 피해 왼쪽보다 중앙 공략.' },
      { hole: 11, par: 4, hdcp: 4, distanceYd: 430, mapImage: yardageImage('mizunami-hole-11-premium-cart-v1.png'), memo: '긴 파4. 티샷 방향이 중요하고 세컨드는 그린 입구를 본다.' },
      { hole: 12, par: 3, hdcp: 10, distanceYd: 198, mapImage: yardageImage('mizunami-hole-12-premium-cart-v1.png'), memo: '긴 파3. 한 클럽 여유 있게 보고 짧은 미스를 피한다.' },
      { hole: 13, par: 4, hdcp: 14, distanceYd: 378, mapImage: yardageImage('mizunami-hole-13-premium-cart-v1.png'), memo: '도그렉 파4. 페어웨이 중앙 확보 후 그린 중앙 공략.' },
      { hole: 14, par: 4, hdcp: 2, distanceYd: 419, mapImage: yardageImage('mizunami-hole-14-premium-cart-v1.png'), memo: '난도 높은 파4. 티샷은 안전한 방향, 세컨드는 무리 금지.' },
      { hole: 15, par: 3, hdcp: 8, distanceYd: 188, mapImage: yardageImage('mizunami-hole-15-premium-cart-v1.png'), memo: '워터 해저드 주의. 핀보다 안전한 그린 면을 본다.' },
      { hole: 16, par: 5, hdcp: 6, distanceYd: 508, mapImage: yardageImage('mizunami-hole-16-premium-cart-v1.png'), memo: '긴 파5. 중간 해저드와 벙커를 피하며 세 번째 샷 각도 확보.' },
      { hole: 17, par: 4, hdcp: 12, distanceYd: 389, mapImage: yardageImage('mizunami-hole-17-premium-cart-v1.png'), memo: '파4. 페어웨이 적중 우선, 그린 주변 벙커 주의.' },
      { hole: 18, par: 4, hdcp: 18, distanceYd: 324, mapImage: yardageImage('mizunami-hole-18-premium-cart-v1.png'), memo: '마무리 파4. 짧지만 좌우 리스크를 피하고 중앙 공략.' },
    ]),
  },
  {
    id: 'hananoki',
    ...
    holes: buildHoles('hananoki', [
      { hole: 1, par: 4, hdcp: 9, distanceYd: 398, mapImage: yardageImage('hananoki-hole-01-premium-cart-v1.png'), memo: '포워드 오른쪽으로 진행. 두 번째 지점은 왼쪽 경사 주의.' },
      { hole: 2, par: 4, hdcp: 15, distanceYd: 381, mapImage: yardageImage('hananoki-hole-02-premium-cart-v1.png'), memo: '오른쪽 공략이 유리. 왼쪽 벙커와 OB를 피한다.' },
      { hole: 3, par: 5, hdcp: 3, distanceYd: 533, mapImage: yardageImage('hananoki-hole-03-premium-cart-v1.png'), memo: '230yd 이내는 중앙~오른쪽, 그 이상은 왼쪽 측면 유지.' },
      { hole: 4, par: 4, hdcp: 7, distanceYd: 352, mapImage: yardageImage('hananoki-hole-04-premium-cart-v1.png'), memo: '포워드 왼쪽이 좋은 위치. 런치 게임이라 큰 클럽 가능.' },
      { hole: 5, par: 3, hdcp: 13, distanceYd: 154, mapImage: yardageImage('hananoki-hole-05-premium-cart-v1.png'), memo: '가로로 긴 그린. 첫 번째 핀과 뒤쪽 OB를 조심.' },
      { hole: 6, par: 4, hdcp: 1, distanceYd: 336, mapImage: yardageImage('hananoki-hole-06-premium-cart-v1.png'), memo: '거리보다 방향 집중. 전체적으로 왼쪽 경사.' },
      { hole: 7, par: 4, hdcp: 5, distanceYd: 350, mapImage: yardageImage('hananoki-hole-07-premium-cart-v1.png'), memo: '앞중앙 조준. 좁은 페어웨이로 방향 제어가 중요.' },
      { hole: 8, par: 3, hdcp: 17, distanceYd: 132, mapImage: yardageImage('hananoki-hole-08-premium-cart-v1.png'), memo: '그린이 세 층. 거리와 방향을 모두 확인.' },
      { hole: 9, par: 5, hdcp: 11, distanceYd: 476, mapImage: yardageImage('hananoki-hole-09-premium-cart-v1.png'), memo: '앞중앙 공략. 그린 앞 벙커와 출발 중 큰 클럽 선택 주의.' },
      { hole: 10, par: 5, hdcp: 16, distanceYd: 517, mapImage: yardageImage('hananoki-hole-10-premium-cart-v1.png'), memo: '왼쪽 도그렉 파5. OB와 오른쪽 연못을 조심.' },
      { hole: 11, par: 4, hdcp: 10, distanceYd: 378, mapImage: yardageImage('hananoki-hole-11-premium-cart-v1.png'), memo: '부드러운 오른쪽 도그렉. 앞쪽 벙커를 겨냥하면 좋다.' },
      { hole: 12, par: 4, hdcp: 4, distanceYd: 405, mapImage: yardageImage('hananoki-hole-12-premium-cart-v1.png'), memo: '왼쪽 OB 주의. 왼쪽 벙커를 넘기는 방향이 좋다.' },
      { hole: 13, par: 3, hdcp: 8, distanceYd: 158, mapImage: yardageImage('hananoki-hole-13-premium-cart-v1.png'), memo: '앞 왼쪽은 벙커. 오른쪽에서 공략하는 것이 안전.' },
      { hole: 14, par: 4, hdcp: 2, distanceYd: 334, mapImage: yardageImage('hananoki-hole-14-premium-cart-v1.png'), memo: '오른쪽 도그렉. 거리 유지 후 앞으로 나아가는 것이 중요.' },
      { hole: 15, par: 3, hdcp: 14, distanceYd: 161, mapImage: yardageImage('hananoki-hole-15-premium-cart-v1.png'), memo: '양쪽 벙커 주의. 특히 왼쪽 벙커는 높이 차가 있다.' },
      { hole: 16, par: 4, hdcp: 6, distanceYd: 376, mapImage: yardageImage('hananoki-hole-16-premium-cart-v1.png'), memo: '왼쪽 도그렉. 너무 멀면 OB 위험, 방향에 집중.' },
      { hole: 17, par: 5, hdcp: 18, distanceYd: 476, mapImage: yardageImage('hananoki-hole-17-premium-cart-v1.png'), memo: '중앙에서 타워 쪽으로 공략. 그린 양쪽 벙커 주의.' },
      { hole: 18, par: 4, hdcp: 12, distanceYd: 408, mapImage: yardageImage('hananoki-hole-18-premium-cart-v1.png'), memo: '클럽하우스 전망대 방향. 두 번째 면은 왼쪽 연못과 벙커 주의.' },
    ]),
  },
]
